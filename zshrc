...
plugins=(brew common-aliases docker docker-compose git node npm)

source $ZSH/oh-my-zsh.sh

export HOMEBREW_OPT="/usr/local/opt"
source $HOMEBREW_OPT/zsh-autosuggestions/share/zsh-autosuggestions/zsh-autosuggestions.zsh
